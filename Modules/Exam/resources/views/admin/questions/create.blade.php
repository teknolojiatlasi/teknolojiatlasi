        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Sınav İçin Soru Oluştur: {{ $exam->title }}</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('exam.exams.questions.store', $exam->id) }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('option_a') is-invalid @enderror" 
                                              id="option_a" name="option_a" rows="2" required>{{ old('option_a') }}</textarea>
                                    @error('option_a')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('option_b') is-invalid @enderror" 
                                              id="option_b" name="option_b" rows="2" required>{{ old('option_b') }}</textarea>
                                    @error('option_b')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('option_c') is-invalid @enderror" 
                                              id="option_c" name="option_c" rows="2" required>{{ old('option_c') }}</textarea>
                                    @error('option_c')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('option_d') is-invalid @enderror" 
                                              id="option_d" name="option_d" rows="2" required>{{ old('option_d') }}</textarea>
                                    @error('option_d')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('option_e') is-invalid @enderror" 
                                              id="option_e" name="option_e" rows="2" required>{{ old('option_e') }}</textarea>
                                    @error('option_e')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
