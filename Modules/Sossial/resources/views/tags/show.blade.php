<x-sossial::layouts.master :title="'#' . $tag->name">
    <section class="sosial-page-hero mb-4">
        <div class="row g-4 align-items-center">
            <div class="col-12 col-lg-8">
                <span class="sosial-kicker"><i class="fa fa-hashtag"></i> Etiket Akışı</span>
                <h1 class="sosial-hero-title">#{{ $tag->name }}</h1>
                <p class="sosial-hero-copy">Bu etiketle ilişkilendirilmiş tüm paylaşımları tek akışta incele.</p>
            </div>
            <div class="col-12 col-lg-4">
                <div class="sosial-hero-metrics">
                    ...
                    <div class="sosial-hero-metric">
                        <a class="btn sosial-btn-secondary w-100" href="{{ route('sosial.explore') }}">Etiket Ara</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="sosial-feed-stack" data-sosial-infinite data-next-url="{{ $posts->nextPageUrl() ?? '' }}">
                    ...
                    @empty
                        <div class="sosial-surface sosial-empty">
                            ...
                            <div class="fw-semibold mb-1">Bu etikette paylaşım yok</div>
                            <p class="mb-0">Başka bir etiketi keşfet ya da ilk paylaşımı sen yap.</p>
                        </div>
                    @endforelse
                </div>
