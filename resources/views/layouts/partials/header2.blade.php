        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navMenu">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('blog.public.index') }}"><i class="fa fa-newspaper-o"></i> Yazılar</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('sosial.feed') }}"><i class="fa fa-envelope"></i> Topluluk</a></li>
